...
<head>
  ...
  <!-- Favicon icon -->
  <link rel="icon" href="assets/img/logobaru.png" type="image/x-icon" />
  ...
  <link rel="stylesheet" href="assets/css/warnacustom.css">
...
<body class="login" >
  ...
  <div class="wrapper wrapper-login bg-maroon" >
    <div class="container container-login animated fadeIn">
      <div class="text-center mb-4"><img src="assets/img/logobaru.png" alt="Logo" width="150px"></div>
      <h3 class="text-center">Aplikasi Barang <br>Gudang</h3>
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="form-action mt-2">
          <input type="submit" name="login" value="LOGIN" class="btn btn-maroon btn-rounded btn-login btn-block">
        </div>
