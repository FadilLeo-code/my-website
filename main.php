...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="author" content="Bolas Rozier" />
  ...
  <body>
    <div class="wrapper">
      <div class="main-header">
        ...
        <!-- Navbar Header -->
        <nav class="navbar navbar-header navbar-expand-lg" style="background-color:rgb(110, 9, 9);">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2025 - <a href="#" class="text-secondary"></a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
